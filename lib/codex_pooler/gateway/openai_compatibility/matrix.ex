defmodule CodexPooler.Gateway.OpenAICompatibility.Matrix do
  ...
  @forwarded_fields %{
    responses:
      ~w(client_metadata include input instructions max_output_tokens metadata model parallel_tool_calls previous_response_id prompt_cache_key prompt_cache_retention reasoning safety_identifier service_tier store stream stream_options temperature text tool_choice tools top_p),
    chat: []
  }
