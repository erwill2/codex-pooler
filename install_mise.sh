...
get_checksum() {
  ...
  current_version="v2026.7.12"
  current_version="${current_version#v}"

  # For current version use static checksum otherwise
  # use checksum from releases
  if [ "$version" = "$current_version" ]; then
    checksum_linux_x86_64="81a05761cb901808bfae3e494e07ec80329eab66a49cd2fa7b8d9cd1ad96683d  ./mise-v2026.7.12-linux-x64.tar.gz"
    checksum_linux_x86_64_musl="d8939817192d8c9158b92cec49cf39be54d258ead5057b9d0a44e16da5f4afa4  ./mise-v2026.7.12-linux-x64-musl.tar.gz"
    checksum_linux_arm64="763f1bccf74f5c34f766a189a4a029a88d44b83f709e28af497ce2aae2704ead  ./mise-v2026.7.12-linux-arm64.tar.gz"
    checksum_linux_arm64_musl="836d58e8652472228adbbf3876829741cbb432d99ce7635a671c9fb5a4eb4070  ./mise-v2026.7.12-linux-arm64-musl.tar.gz"
    checksum_linux_armv7="f555ba158515e7346e27d058d8dc9e2d20f95eb1fd685f366c73f0b0bfb965b1  ./mise-v2026.7.12-linux-armv7.tar.gz"
    checksum_linux_armv7_musl="daa6caf5c89f00e379d38dd8094b7ec6dce9827141c4889817b8879be7492f25  ./mise-v2026.7.12-linux-armv7-musl.tar.gz"
    checksum_macos_x86_64="e0986804aff135212cde044f6c5f7c4be3e7265640dfe79dc83bc1bebc392c4b  ./mise-v2026.7.12-macos-x64.tar.gz"
    checksum_macos_arm64="a73e15eb4974abf7c5c9445365e89cf2d8ec18afc97d4e161b317e65a404f261  ./mise-v2026.7.12-macos-arm64.tar.gz"
    checksum_linux_x86_64_zstd="a34fa12a69845fc9f252ac977100d199e5fecdcc0db8347115ed9589e586ec4d  ./mise-v2026.7.12-linux-x64.tar.zst"
    checksum_linux_x86_64_musl_zstd="6bac339aed7d6f4b4cbd8ac220f973cd4cff3082a2f2601260f8dd7265a34c14  ./mise-v2026.7.12-linux-x64-musl.tar.zst"
    checksum_linux_arm64_zstd="2c4578f5802c0d60d03b76f8b713dc5e0e04aeaee585a956f53d420d73f92fa9  ./mise-v2026.7.12-linux-arm64.tar.zst"
    checksum_linux_arm64_musl_zstd="5f8071b5adc479d283f65b0b5c2f0ef5861025f0a3aad4ecb19d074cdbb7b054  ./mise-v2026.7.12-linux-arm64-musl.tar.zst"
    checksum_linux_armv7_zstd="e1c5ef2b2f96e2924886f86ad81eb30f2ced5537fb56b22f58fe652e8a143717  ./mise-v2026.7.12-linux-armv7.tar.zst"
    checksum_linux_armv7_musl_zstd="0e8ede50b3c5aa572ea592860a82ae2b3bc3ebb098934eef9c05771b4a492e92  ./mise-v2026.7.12-linux-armv7-musl.tar.zst"
    checksum_macos_x86_64_zstd="ea4446435529888a8cbe5a3c3ec60ee8a7314523eaf270009b1a2ba31bf30179  ./mise-v2026.7.12-macos-x64.tar.zst"
    checksum_macos_arm64_zstd="4c6e6a7851eaf70c30dfa4e9626e92bdc21b2fb36ac814fd10c1f76e96b55021  ./mise-v2026.7.12-macos-arm64.tar.zst"
...
install_mise() {
  version="${MISE_VERSION:-v2026.7.12}"
  version="${version#v}"
  current_version="v2026.7.12"
  current_version="${current_version#v}"
