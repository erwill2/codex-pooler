...
Use [Stats](/operators/stats/) for aggregate request, token, and cost analytics. Use [Request logs](/operators/request-logs/) for request-level investigation, including API key context, outcomes, and available settled usage metadata.
