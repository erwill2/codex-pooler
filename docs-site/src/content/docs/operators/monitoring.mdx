...
![Codex Pooler Grafana memory triage dashboard](/codex-pooler-grafana.png)

[Download the starter Grafana dashboard JSON](/operators/monitoring/codex-pooler-memory-triage.json)
