...
OpenAI's [Codex authentication docs](https://developers.openai.com/codex/auth) describe device-code login. If device-code authorization is off, the Codex Pooler invite can still be active, but OpenAI can block the approval step and the upstream will not become ready.
